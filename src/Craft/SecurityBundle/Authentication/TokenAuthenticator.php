...
use Craft\SecurityBundle\User\SecurityUserInterface;
use Craft\SecurityBundle\User\SecurityUserProvider;
use Craft\SecurityBundle\User\SecurityUserProviderInterface;
 ...
 * @package Craft\SecurityBundleBundle\Authenticator
 *
...
class TokenAuthenticator extends AbstractGuardAuthenticator
{
    ...
    public function __construct(SecurityUserProviderInterface $apiUserProvider)
    {
    ...
    {
        return $this->getApiUser($credentials['token']);
    }
